 ...
 */
final class Version20200511182956 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE multimedia (id INT AUTO_INCREMENT NOT NULL, id_tipo INT DEFAULT NULL, id_art INT NOT NULL, src VARCHAR(2000) NOT NULL, home TINYINT(1) NOT NULL, is_active TINYINT(1) NOT NULL, INDEX id_art (id_art), INDEX id_tipo (id_tipo), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
